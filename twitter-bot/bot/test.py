...
class Twitter_Api():
    ...
    def tweet(self, tweet):
        ...
        stat = api.update_status(
            tweet + " " + "#GeneratedText" + " " + "#MarkovChain")
...
def main():
    ...
    access_secret = 'W4Ot9vosq6jEWJoBtB7ZVjicfAHhLLTMRV4LURto3k8Ve'
    documents = ["bot/corpus1.csv", "bot/corpus2.csv", 'bot/corpus3.csv']
